...
PROMPT='%{$fg_bold[blue]%}%n@%{$fg_bold[cyan]%}%m %{$fg_bold[blue]%}%1001~%{$reset_color%}$(git_prompt_info)
%{$fg_bold[white]%}› %{$reset_color%}'
# PROMPT='%{$fg_bold[blue]%}%n %{$fg_bold[blue]%}%1001~%{$reset_color%}$(git_prompt_info)%{$reset_color%} %{$fg_bold[cyan]%} '
# PROMPT='%{$fg_bold[blue]%}%3c%{$reset_color%}$(git_prompt_info)%{$reset_color%} '
